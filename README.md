...
The [**scripts/**](scripts/README.md) directory contains example command-line scripts to help users perform local sequence alignment and structural search using the downloaded databases.
