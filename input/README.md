This folder contains the original input files used in the PETase case study, as presented in the ThermoSeek publication. These files were submitted to the ThermoSeek webserver to perform Fold Search, Sequence Alignment and Motif Search.
